...
from fdc3_desktop_agent.api import ConnectionAttemptUuid, Timestamp
...
class WCP5ValidateAppIdentityResponse(BaseModel):
    type: Literal["WCP5ValidateAppIdentityResponse"] = Field(default="WCP5ValidateAppIdentityResponse")
...
class WCP5ValidateAppIdentityFailedResponse(BaseModel):
    type: Literal["WCP5ValidateAppIdentityFailedResponse"] = Field(default="WCP5ValidateAppIdentityFailedResponse")
