...
class AppRegistry:
    ...
    def __init__(self):
        ...
        self._connection_events: Dict[str, asyncio.Event] = {}  # instance_uuid -> connection event

    def register_pending_instance(self, app_id: str, instance_id: str, instance_uuid: str) -> AppInstance:
    ...
    def register_instance(self, app_id: str, instance_id: str, instance_uuid: str) -> AppInstance:
    ...
    def get_connected_instances_for_app(self, app_id: str) -> List[AppInstance]:
        return [inst for inst in self.instances.values() if inst.app_id == app_id and inst.connected]

    async def wait_for_instance_connection(self, instance_uuid: str, timeout: Optional[float] = None) -> bool:
        ...
        try:
            await asyncio.wait_for(self._connection_events[instance_uuid].wait(), timeout=timeout)
            return True
