...
class ChannelInstance:
    def __init__(self, channel_id: str, channel_type: str, display_metadata: Optional[DisplayMetadata] = None):
        self.id = channel_id
...
class ChannelManager:
    ...
    def broadcast_to_channel(self, channel_id: str, context: Dict[str, Any], source_instance_uuid: str):
    ...
    def subscribe_to_events(self, callback: Callable[[Dict[str, Any]], None], channel_filter: Optional[str] = None) -> str:
